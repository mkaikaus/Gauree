    ...
    <div class="section">
        <div class="container">
            <div class="content-section">
                ...
                <div class="content">
                    <h3>Gauree is a online based jewellary shop</h3>
                    <p>Gauree is online based.we sell jewellary item like germar silver ,south indian,metal and gold plated jewellary.we do customized works also.The motive of gauree is to provide the best service to the customers.we try our best to provide
                        the best quality </p>
                    <div class="button">
                        <a href="../php/home.php">Read More</a>
                    </div>
                </div>
                <div class="social">
