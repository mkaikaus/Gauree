...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand logo logo1" style="color: rebeccapurple;" href="#">Gauree</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item" style="margin: 5px ;background-color: rebeccapurple">
                        <a class="nav-link text-light" href="admin_login.html"><b>Admin Login</b></a>
                    </li>
                    <li class="nav-item " style="margin: 5px ;background-color: rebeccapurple;">
                        <a class="nav-link text-light" href="customer_login.html"><b>Customer - Login/Sign up</b></a>
                    </li>
                </ul>
            </div>
        </div>
