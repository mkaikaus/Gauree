...
<body>
  ...
  <!--end of a navbar-->
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-md-6 col-lg-9">
                    <div class="jumbotron box">
                        <h1 class="header mt-0">Delivery Rules</h1>
                        <p class="text-1 mt-3">Please read the rules before you place an order!</p>
                        <p class="text-1 mt-5">Please Read:</p>
                        <p class="text-1 mt-0">-You have to confirm your Name,Address,Phone Number before placing the order.</p>
                        <p class="text-1">-No hold No cancelation.</p>
                        <p class="text-1">-No booking mooney needed.</p>
                        <p class="text-1">-Inside Dhaka You have to pay delivery charge 80tk only.But Outside Dhaka You have to pay 100tk only.for outside Dhaka you have to take your parcel from Sundarban Courier Service and have to pay full payment with charge on BKASH.</p>
                        <p class="text-1">-Inside Dhaka Delivery within 1-3 days.Outside Dhaka Delivery within 2-4 days.</p><br>
                        <hr>
                    </div>
                </div>
    ...
    <div class="link p-5 links">
        <a class="c_link" href="#">
            <a href="#" class="fab fa-linkedin l_icon1"></a>
        </a>
    ...
    <footer class="text-center mt-0 mb-0">
        <p class="f-text pt-5 text-white animate__animated animate__zoomIn wow zoomIn"><i class="far fa-copyright"></i> COPYRIGHTS BY <span class="logo-text">Gauree-গৌরি. </span> ALL RIGHTS RESERVED</p>
    </footer>
